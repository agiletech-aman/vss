        ...
        <div class="d-flex w-100 align-items-center">
            ...
            <div class="d-flex align-items-center">
                <div class="navbar-brand-box">
                    <a href="{{ route('dashboard') }}" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ asset('backends/assets/images/cwc.jpg') }}" alt="logo-sm" height="40">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('backends/assets/images/cwclogo.png') }}" alt="logo-dark">
                        </span>
                    </a>

                    <a href="{{ route('dashboard') }}" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{ asset('backends/assets/images/cwc.jpg') }}" alt="logo-sm-light" height="40">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('backends/assets/images/cwclogo.png') }}" alt="logo-light">
                        </span>
                    </a>
                </div>
            ...
            <div class="flex-grow-1 text-left px-3">
                ...
                @if($user->hasRole('region_officer') && $user->region)
                    <small class="text-white-50 d-block mt-1">
                        <i class="ri-map-pin-line"></i> {{ $user->region->name }} Region
                    </small>
                @elseif($user->hasRole('warehouse_officer') && $user->warehouse)
                    <small class="text-white-50 d-block mt-1">
                        <i class="ri-building-line"></i> {{ $user->warehouse->warehouse }}
                    </small>
                @endif
            </div>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="d-none d-lg-block">
                    <span class="badge badge-soft-{{ $currentRole['color'] }} px-3 py-2">
                        <i class="{{ $currentRole['icon'] }} me-1"></i>
                        {{ $currentRole['label'] }}
                    </span>
                </div>
                ...
                <div class="dropdown d-inline-block user-dropdown">
                    <button type="button" class="btn header-item bg-soft-light waves-effect"
                        ...
                        <img class="rounded-circle header-profile-user"
                             src="{{ asset('backends/assets/images/users/user.png') }}"
                             alt="Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" style="min-width: 280px;">
                        <div class="p-3 bg-soft-{{ $currentRole['color'] }} border-bottom">
                            <div class="d-flex align-items-center">
                            ...
                            <div class="mt-2">
                                <span class="badge bg-{{ $currentRole['color'] }} px-2 py-1">
                                    <i class="{{ $currentRole['icon'] }} me-1"></i>
                                    {{ $currentRole['label'] }}
                                </span>
                            </div>
                            @if($user->hasRole('region_officer') && $user->region)
                                <div class="mt-2 pt-2 border-top border-white">
                                    ...
                                    <small class="text-muted d-flex align-items-center mt-1">
                                        ...
                                        <strong>Warehouses:</strong>&nbsp;{{ $user->getAccessibleWarehouses()->count() }}
                                    </small>
                                </div>
                            @elseif($user->hasRole('warehouse_officer') && $user->warehouse)
                                <div class="mt-2 pt-2 border-top border-white">
                                    <small class="text-muted d-flex align-items-center">
                                        <i class="ri-building-line me-2"></i>
                                        <strong>Warehouse:</strong>&nbsp;{{ $user->warehouse->warehouse }}
                                    </small>
                                    <small class="text-muted d-flex align-items-center mt-1">
                                        <i class="ri-map-pin-line me-2"></i>
                                        <strong>Region:</strong>&nbsp;{{ $user->warehouse->region->name }}
                                    </small>
                                </div>
                            @endif
                        </div>
