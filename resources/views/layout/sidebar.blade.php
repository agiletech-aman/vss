            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="{{ $nmsActive ? 'mm-active' : '' }}">
                    ...
                    <ul class="sub-menu {{ $nmsActive ? 'mm-show' : '' }}">
                        ...
                        <li class="{{ $currentRoute === 'nms.pages.poll-history' ? 'mm-active' : '' }}">
                            <a href="{{ route('nms.pages.poll-history') }}" class="{{ $currentRoute === 'nms.pages.poll-history' ? 'active' : '' }}">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <!-- <li><a href="{{ route('alerts.index', ['deviceTypeId' => 30000]) }}">CO₂ Alerts</a></li>
                        <li><a href="{{ route('alerts.index', ['deviceTypeId' => 30001]) }}">Phosphine Alerts</a></li> -->
                        <li><a href="{{ route('gas.alerts.index', ['deviceTypeId' => 30000]) }}">CO₂ Alerts</a></li>
                        <li><a href="{{ route('gas.alerts.index', ['deviceTypeId' => 30001]) }}">Phosphine Alerts</a></li>
                    </ul>
                </li>
