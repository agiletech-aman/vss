...
<div class="page-header">
    ...
    <a href="{{ route('nms.pages.dashboard') }}" class="page-back-btn">
...
<div class="filter-card">
    <div class="row g-2 align-items-end">
        ...
        <div class="col-md-2">
            ...
            <input type="date" id="filterFrom" class="form-control" value="{{ date('Y-m-d', strtotime('-7 days')) }}">
        </div>
        <div class="col-md-2">
...
<script>
const NMS_BASE   = '{{ config("external-apis.nms_base", "https://nms.cwcnewcctv.in/api/nms/v1") }}';
