...
@section('title', 'API Data Monitor')
@section('content')
...
<script>
const NMS_BASE  = '{{ $nmsBase ?? "https://nms.cwcnewcctv.in/api/nms/v1" }}';
const FRS_BASE_RAW  = '{{ $frsBase ?? "https://frsbag.cwcnewiot.in" }}';
const SACK_BASE_RAW = '{{ $sackBase ?? "https://frsbag.cwcnewiot.in" }}';
...
const IOT_BASE  = '{{ $iotBase ?? config("external-apis.iot_base") }}';
