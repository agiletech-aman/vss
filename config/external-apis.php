...
return [
    ...
    */
    ...
    'nms_cam_base' => env('NMS_CAM_BASE', 'https://new.cwcnewcctv.in'),

    /*
    |--------------------------------------------------------------------------
    | CO2 / PH3 / Fire / Smoke / Rodent
    |--------------------------------------------------------------------------
    */
    ...
    // Browser-side IoT pages need the API host (without the /api path).
    'iot_base'                => env('API_IOT_BASE',          'https://co2ph3master.agiletech.net.in'),
    'alert_dashboard'         => env('API_ALERT_DASHBOARD',   'https://co2ph3master.agiletech.net.in/api/camera-summary/dashboard'),
