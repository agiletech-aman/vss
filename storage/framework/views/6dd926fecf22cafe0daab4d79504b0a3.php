<?php $__env->startSection('title', 'NMS — Live Map'); ?>
...
function renderPins(pins) {
    ...
    pins.forEach(pin => {
        ...
        m.on('click',     () => { window.location.href = '<?php echo e(route('nms.pages.warehouse.detail', '')); ?>/'+pin.warehouse_id; });
