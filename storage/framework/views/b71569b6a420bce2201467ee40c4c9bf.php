...
<div class="page-header">
    ...
    <div style="display:flex;align-items:center;gap:10px;">
        <div class="gas-toggle-buttons">
            <a href="<?php echo e(route('alerts.index', ['deviceTypeId' => 30000])); ?>"
               class="btn <?php echo e($deviceTypeId == 30000 ? 'btn-success' : 'btn-outline-success'); ?>">
                <i class="ri-cloud-line me-1"></i> CO₂
            </a>
            <a href="<?php echo e(route('alerts.index', ['deviceTypeId' => 30001])); ?>"
...
<div class="kpi-row">
    <a href="<?php echo e(route('alerts.index', array_merge(request()->except(['alertType','page']), ['deviceTypeId'=>$deviceTypeId,'alertType'=>'NORMAL']))); ?>"
    ...
    <a href="<?php echo e(route('alerts.index', array_merge(request()->except(['alertType','page']), ['deviceTypeId'=>$deviceTypeId,'alertType'=>'SEVERE']))); ?>"
    ...
    <a href="<?php echo e(route('alerts.index', array_merge(request()->except(['alertType','page']), ['deviceTypeId'=>$deviceTypeId,'alertType'=>'CRITICAL']))); ?>"
...
<div class="filter-card">
    <form method="GET" id="filterForm" class="row g-2 align-items-end">
        ...
        <div class="col-md-2">
            ...
            <select id="stateSelect" name="state" class="form-select">
                ...
                <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $stateValue = is_array($s) ? (data_get($s, 'name') ?: data_get($s, 'label') ?: data_get($s, 'value') ?: '') : (string) $s; ?>
                    <option value="<?php echo e($stateValue); ?>" <?php echo e($selectedState==$stateValue ? 'selected' : ''); ?>><?php echo e($stateValue); ?></option>
        ...
        <div class="col-md-2">
            ...
            <select id="locationSelect" name="location" class="form-select">
                ...
                <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $locationValue = is_array($loc) ? (data_get($loc, 'name') ?: data_get($loc, 'label') ?: data_get($loc, 'value') ?: '') : (string) $loc; ?>
                    <option value="<?php echo e($locationValue); ?>" <?php echo e($selectedLocation==$locationValue ? 'selected' : ''); ?>><?php echo e($locationValue); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-2 d-flex gap-2 align-items-end">
            ...
            <a href="<?php echo e(route('alerts.index', ['deviceTypeId' => $deviceTypeId])); ?>"
    ...
    <div class="table-card-header">
        <div class="table-card-title">
            ...
            <?php if($selectedAlertType): ?>
                <span class="badge <?php echo e($selectedAlertType=='CRITICAL' ? 'badge-critical' : ($selectedAlertType=='SEVERE' ? 'badge-severe' : 'badge-normal')); ?>">
    ...
    <nav>
        <ul class="pagination mb-0">
            <li class="page-item <?php echo e($page<=1 ? 'disabled' : ''); ?>">
                <a class="page-link" href="<?php echo e($page<=1 ? '#' : route('alerts.index', array_merge(request()->except('page'),['page'=>1]))); ?>">
                    <i class="ri-skip-back-mini-line"></i> First
                </a>
            </li>
            <li class="page-item <?php echo e($page<=1 ? 'disabled' : ''); ?>">
                <a class="page-link" href="<?php echo e($page<=1 ? '#' : route('alerts.index', array_merge(request()->except('page'),['page'=>max(1,$page-1)]))); ?>">
            ...
            <?php for($i=$start; $i<=$end; $i++): ?>
                <li class="page-item <?php echo e($i==$page ? 'active' : ''); ?>">
                    <a class="page-link" href="<?php echo e(route('alerts.index', array_merge(request()->except('page'),['page'=>$i]))); ?>"><?php echo e(number_format($i)); ?></a>
                </li>
            <?php endfor; ?>
            <li class="page-item <?php echo e($page>=$totalPages ? 'disabled' : ''); ?>">
                <a class="page-link" href="<?php echo e($page>=$totalPages ? '#' : route('alerts.index', array_merge(request()->except('page'),['page'=>min($totalPages,$page+1)]))); ?>">
                    Next <i class="ri-arrow-right-s-line"></i>
                </a>
            </li>
            <li class="page-item <?php echo e($page>=$totalPages ? 'disabled' : ''); ?>">
                <a class="page-link" href="<?php echo e($page>=$totalPages ? '#' : route('alerts.index', array_merge(request()->except('page'),['page'=>$totalPages]))); ?>">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadLocations(state, preselectValue = null) {
        ...
        fetch(`<?php echo e(route('alerts.locations', ['state' => '__STATE__'])); ?>`.replace('__STATE__', encodeURIComponent(state)))
            .then(res => res.json())
            .then(data => {
...
function exportToServer() {
    ...
    window.location.href = '<?php echo e(route("alerts.export")); ?>?' + params.toString();
}
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ATS\vss\resources\views\alerts\index.blade.php ENDPATH**/ ?>