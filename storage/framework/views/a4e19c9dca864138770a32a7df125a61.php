<?php $__env->startSection('title', 'Smoke Alerts'); ?>
        ...
        <form method="GET" class="row g-3">
            ...
            <div class="col-md-2">
                ...
                <div class="filter-actions">
                    ...
                    <a href="<?php echo e(route('alerts.smoke')); ?>" class="btn-reset"><i class="ri-refresh-line"></i></a>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="table-card">
        <div class="table-card-header">
            ...
            <div style="display:flex;align-items:center;gap:10px;">
                ...
                <a href="<?php echo e(route('alerts.smoke.export')); ?>?<?php echo e(http_build_query(request()->query())); ?>"
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if(!empty($row['imagePath'])): ?>
                                    ...
                                    <img src="<?php echo e($imageUrl); ?>" class="preview-img" data-full="<?php echo e($imageUrl); ?>" loading="lazy" onerror="this.style.display='none'" alt="Smoke Alert">
                                <?php else: ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ATS\vss\resources\views\alerts\smoke.blade.php ENDPATH**/ ?>