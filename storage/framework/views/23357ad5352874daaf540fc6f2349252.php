<?php $__env->startSection('title','NMS — Warehouses'); ?>
...
<div class="wh-tabs">
    <a href="<?php echo e(route('dashboard')); ?>"            class="wh-tab">Dashboard</a>
    <a href="<?php echo e(route('nms.pages.regions')); ?>"    class="wh-tab">Regions</a>
    <a href="<?php echo e(route('nms.pages.warehouses')); ?>" class="wh-tab active">Warehouses</a>
    <a href="<?php echo e(route('nms.pages.map')); ?>"        class="wh-tab">Live Map</a>
