<?php $__env->startSection('title', $region . ' - Warehouses'); ?>
...
<div class="rw-page">
    ...
    <div class="rw-header">
        <div class="rw-header-top">
            <div class="rw-header-left">
                ...
                <div>
                    <div class="rw-title"><?php echo e($region); ?></div>
                    <div class="rw-subtitle">Camera Network Overview • <?php echo e($stats['warehouse_count'] ?? 0); ?> Warehouses</div>
                </div>
            </div>

            
            <a href="<?php echo e(route('dashboard')); ?>" class="rw-back-btn">
    ...
    <div class="rw-stats-grid">
        ...
        <div class="rw-stat-card" style="border-top:3px solid var(--rw-blue);">
            ...
            <div class="rw-stat-value" style="color:var(--rw-blue);"><?php echo e(number_format($stats['total_cameras'] ?? 0)); ?></div>
        ...
        <div class="rw-stat-card" style="border-top:3px solid var(--rw-green);">
            ...
            <div class="rw-stat-value" style="color:var(--rw-green);"><?php echo e(number_format($stats['online_cameras'] ?? 0)); ?></div>
            <div class="rw-stat-meta">
        ...
        <div class="rw-stat-card" style="border-top:3px solid var(--rw-red);">
            ...
            <div class="rw-stat-value" style="color:var(--rw-red);"><?php echo e(number_format($stats['offline_cameras'] ?? 0)); ?></div>
            <div class="rw-stat-meta">
        ...
        <div class="rw-stat-card" style="border-top:3px solid var(--rw-orange);">
            ...
            <div class="rw-stat-value" style="color:var(--rw-orange);"><?php echo e($stats['online_percent'] ?? 0); ?>%</div>
            <div class="rw-stat-meta">
    ...
    <div class="rw-section-label">
        ...
        Warehouses in <?php echo e($region); ?>
    ...
    <div class="rw-warehouse-grid">
        <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a href="<?php echo e(route('cameras.warehouse.details', ['region' => $region, 'warehouse' => $warehouse['warehouse'] ?? ''])); ?>" class="rw-warehouse-card">
                <div class="rw-warehouse-header">
                    <div class="rw-warehouse-name">
                        <i class="ri-building-line"></i>
                        <?php echo e($warehouse['warehouse'] ?? 'Unknown'); ?>

                    </div>
                    <div class="rw-warehouse-status" style="background:<?php echo e($statusBg); ?>;color:<?php echo e($statusColor); ?>;">
                ...
                <div class="rw-warehouse-stats">
                    <div class="rw-stat-item">
                        ...
                        <span class="rw-stat-item-value"><?php echo e($warehouse['total_cameras'] ?? 0); ?></span>
                    </div>
                    <div class="rw-stat-item">
                        <span class="rw-stat-item-label">Online Cameras</span>
                        <span class="rw-stat-item-value" style="color:var(--rw-green);"><?php echo e($warehouse['online_cameras'] ?? 0); ?></span>
                    </div>
                    <div class="rw-stat-item">
                        <span class="rw-stat-item-label">Offline Cameras</span>
                        <span class="rw-stat-item-value" style="color:var(--rw-red);"><?php echo e($warehouse['offline_cameras'] ?? 0); ?></span>
                    </div>
                    <div class="rw-stat-item">
                        <span class="rw-stat-item-label">Uptime</span>
                        <span class="rw-stat-item-value" style="color:<?php echo e($statusColor); ?>;"><?php echo e($warehouse['online_percent'] ?? 0); ?>%</span>
                    </div>
                </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ATS\vss\resources\views\cameras\region_warehouses.blade.php ENDPATH**/ ?>