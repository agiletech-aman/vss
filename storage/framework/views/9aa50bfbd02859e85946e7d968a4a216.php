<?php $__env->startSection('title','NMS — <?php echo e($region); ?>'); ?>
...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
    <div style="display:flex;align-items:center;gap:6px;font-size:12.5px;font-weight:600;color:var(--muted);">
        <a href="<?php echo e(route('nms.pages.regions')); ?>" style="color:var(--blue);text-decoration:none;">Regions</a>
        <i class="ri-arrow-right-s-line"></i>
        <span style="color:var(--text);"><?php echo e($region); ?></span>
    </div>
    <a href="<?php echo e(route('nms.pages.regions')); ?>" style="display:inline-flex;align-items:center;gap:5px;padding:6px 14px;background:#f1f5f9;border:1.5px solid #e2e8f0;border-radius:8px;font-size:12px;font-weight:700;color:#475569;text-decoration:none;" onmouseover="this.style.background='#e2e8f0'" onmouseout="this.style.background='#f1f5f9'">
...
<div style="background:var(--navy);border-radius:12px;padding:20px 24px;margin-bottom:18px;color:#fff;box-shadow:0 4px 16px rgba(0,0,0,.1);">
    ...
    <div style="font-size:20px;font-weight:800;margin-bottom:14px;"><?php echo e($region); ?></div>
...
<div class="nms-card">
    <div class="nms-card-hdr">
        <div class="nms-card-title"><i class="ri-building-2-line"></i> Warehouses in <?php echo e($region); ?></div>
    </div>
...
<span id="whDetailBase" style="display:none;"><?php echo e(route('nms.pages.warehouse.detail', '')); ?></span>
