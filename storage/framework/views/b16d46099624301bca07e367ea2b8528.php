<?php $__env->startSection('title', 'Face Recognition Logs'); ?>
...
<script>
    const FRS_ALL_LOGS = <?php echo json_encode($allLogsForExport, 15, 512) ?>;
</script>
...
<div class="filter-card">
    <form method="GET" id="frsFilterForm" class="row g-2 align-items-end">
        ...
        <input type="hidden" name="region_id"      id="region_id_input"     value="<?php echo e(request('region_id')); ?>">
        <input type="hidden" name="warehouse_id"   id="warehouse_id_input"  value="<?php echo e(request('warehouse_id')); ?>">
        <input type="hidden" name="region_name"    id="region_name"         value="<?php echo e(request('region_name')); ?>">
        <input type="hidden" name="warehouse_name" id="warehouse_name"      value="<?php echo e(request('warehouse_name')); ?>">
        ...
        <div class="col-md-1">
            <a href="<?php echo e(route('frs.logs')); ?>" class="btn-reset w-100">
    ...
    <div class="table-card-header">
        ...
        <div class="table-card-actions">
            ...
            <span class="record-count-badge">
                <?php echo e($paginatedLogs->count()); ?> of <?php echo e($total); ?> records
            </span>
            <?php if($total > 0): ?>
            <button onclick="exportFrsExcel()" class="btn-export">
                <i class="ri-file-excel-line"></i>
                Export Excel (<?php echo e($total); ?>)
            </button>
            <?php endif; ?>
        </div>
    </div>
    <div class="table-card-body">
        <div class="table-responsive">
            <table id="frsTable" class="table table-bordered align-middle w-100">
                ...
                <?php $__currentLoopData = $paginatedLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <tr>
                        <td class="text-nowrap">
                            <?php echo e(\Carbon\Carbon::parse($log['timestamp'])->format('d-m-Y H:i:s')); ?>

                        </td>
                        <td title="<?php echo e($log['name'] ?? 'Unknown'); ?>"><?php echo e($log['name'] ?? 'Unknown'); ?></td>
                        <td>
                            <span class="badge <?php echo e(($log['status'] ?? '') === 'known' ? 'bg-success' : 'bg-secondary'); ?>">
                                <?php echo e(ucfirst($log['status'] ?? 'unknown')); ?>

                            </span>
                        </td>
                        
                        <td title="<?php echo e($log['region'] ?? '-'); ?>"><?php echo e($log['region'] ?? '-'); ?></td>
                        <td title="<?php echo e($log['warehouse'] ?? '-'); ?>"><?php echo e($log['warehouse'] ?? '-'); ?></td>
                        <td title="<?php echo e($log['camera_label'] ?? '-'); ?>"><?php echo e($log['camera_label'] ?? '-'); ?></td>

                        
                        <td class="text-center">
                            <?php if($cropUrl): ?>
                                <img src="<?php echo e($cropUrl); ?>"
                                     class="img-thumbnail preview-img"
                                     data-full="<?php echo e($cropUrl); ?>"
                                     data-alt="<?php echo e($cropAlt); ?>"
                                     loading="lazy"
                        ...
                        <td class="text-center">
                            <?php if($frameUrl): ?>
                                <img src="<?php echo e($frameUrl); ?>"
                                     class="img-thumbnail preview-img"
                                     data-full="<?php echo e($frameUrl); ?>"
                                     data-alt="<?php echo e($frameAlt); ?>"
                                     loading="lazy"
                                     onerror="if(!this.dataset.tried){this.dataset.tried=1;this.src=this.dataset.alt;}else{this.style.display='none';}"
                                     alt="Frame">
                            <?php else: ?>
...
<div class="mt-3">
    <?php echo e($paginatedLogs->appends(request()->query())->links('pagination::bootstrap-5')); ?>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const selectedRegionId    = "<?php echo e(request('region_id')); ?>";
    const selectedWarehouseId = "<?php echo e(request('warehouse_id')); ?>";
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ATS\vss\resources\views\iot\frs.blade.php ENDPATH**/ ?>