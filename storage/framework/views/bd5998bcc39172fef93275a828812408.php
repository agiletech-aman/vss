<?php $__env->startSection('title', 'Bag Counting'); ?>
...
<div class="filter-card">
    <form method="GET" id="sackFilterForm" class="row g-2 align-items-end">
        <input type="hidden" name="region_id"    id="region_id_hidden"    value="<?php echo e(request('region_id')); ?>">
        <input type="hidden" name="warehouse_id" id="warehouse_id_hidden" value="<?php echo e(request('warehouse_id')); ?>">
        <div class="col-md-3">
        ...
        <div class="col-md-1">
            <a href="<?php echo e(route('sack.count')); ?>" class="btn-reset w-100"><i class="ri-refresh-line"></i></a>
        </div>
    </form>
</div>
...
<div class="table-card" id="drillCard" <?php echo e(count($records) > 0 ? 'style=display:none' : ''); ?>>
...
<div class="table-card mt-3" id="detailCard">
    <div class="table-card-header">
        ...
        <div style="display:flex;align-items:center;gap:10px">
            <span class="record-count-badge"><?php echo e(count($records)); ?> record(s)</span>
            ...
            <table id="sackTable" class="table align-middle w-100">
                ...
                <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($row['godown']      ?? '-'); ?></td>
                        <td><?php echo e($row['compartment'] ?? '-'); ?></td>
                        <td class="td-in"><?php echo e(number_format($row['Day_Total_In']  ?? 0)); ?></td>
                        <td class="td-out"><?php echo e(number_format($row['Day_Total_Out'] ?? 0)); ?></td>
                    </tr>
...
const SACK_ROUTE  = '<?php echo e(route("sack.count")); ?>';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const selRid       = "<?php echo e(request('region_id')); ?>";
    const selWid       = "<?php echo e(request('warehouse_id')); ?>";
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ATS\vss\resources\views\iot\sack.blade.php ENDPATH**/ ?>