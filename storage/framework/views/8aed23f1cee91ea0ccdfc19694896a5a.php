...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-bottom:18px;">
    <div class="nms-card">
        <div class="nms-card-hdr">
            ...
            <a href="<?php echo e(route('nms.pages.regions')); ?>" class="nms-btn-sm nms-btn-sm-navy">View all <i class="ri-arrow-right-line"></i></a>
        </div>
    ...
    <div class="nms-card">
        <div class="nms-card-hdr">
            ...
            <a href="<?php echo e(route('nms.pages.regions')); ?>" class="nms-btn-sm nms-btn-sm-navy">Warehouses <i class="ri-arrow-right-line"></i></a>
        </div>
...
<div style="display:grid;grid-template-columns:1fr 2fr;gap:18px;margin-bottom:18px;">
    ...
    <div class="nms-card">
        <div class="nms-card-hdr">
            ...
            <a href="<?php echo e(route('nms.pages.regions')); ?>" class="nms-btn-sm nms-btn-sm-blue">Warehouses <i class="ri-arrow-right-line"></i></a>
        </div>
