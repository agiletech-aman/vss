    ...
    <div class="wd-header">
        <div class="wd-header-title">
            ...
            <div class="wd-header-info">
                <h4><?php echo e($warehouse); ?></h4>
                <p><?php echo e($region); ?> Region • Camera Health Status</p>
            </div>
        </div>

        <a href="<?php echo e(route('cameras.region', ['region' => $region])); ?>" class="wd-back-btn">
    ...
    <?php elseif(isset($data)): ?>
        ...
        <div class="wd-stats-grid">
            <div class="wd-stat-card total">
                ...
                <div class="wd-stat-value"><?php echo e(number_format($d['total_cameras'] ?? 0)); ?></div>
            </div>

            <div class="wd-stat-card online">
                <div class="wd-stat-label">Online Cameras</div>
                <div class="wd-stat-value"><?php echo e(number_format($d['online_cameras'] ?? 0)); ?></div>
            </div>
            ...
            <div class="wd-stat-card offline">
                ...
                ?>
                <div class="wd-stat-value"><?php echo e(number_format($totalOffline)); ?></div>
            </div>

            <div class="wd-stat-card uptime">
                <div class="wd-stat-label">Uptime</div>
                <div class="wd-stat-value"><?php echo e($d['uptime'] ?? 0); ?>%</div>
            </div>
        </div>
        ...
        <div class="wd-section-label">
            ...
            NVR Configuration (<?php echo e($d['nvr_count'] ?? 0); ?> <?php echo e(($d['nvr_count'] ?? 0) === 1 ? 'NVR' : 'NVRs'); ?>)
        </div>

        <div class="wd-nvr-grid">
            <?php $__currentLoopData = ($d['nvrs'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $nvr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="wd-nvr-card <?php echo e($nvrStatusClass); ?>">
                    <!-- NVR Header -->
                    <div class="wd-nvr-header">
                        <div>
                            <div class="wd-nvr-title">NVR #<?php echo e($index + 1); ?></div>
                            <div class="wd-nvr-type"><?php echo e($nvr['type'] ?? 'Unknown'); ?></div>
                        </div>
                        <div class="wd-nvr-status-badge <?php echo e(($nvr['nvr_reachable'] ?? false) ? 'reachable' : 'unreachable'); ?>">
                            <?php echo e(($nvr['nvr_reachable'] ?? false) ? '● Reachable' : '● Unreachable'); ?>
                    ...
                    <div class="wd-nvr-info-grid">
                        <div class="wd-nvr-info-item">
                            ...
                            <div class="wd-nvr-info-value"><?php echo e($nvr['ip'] ?? '-'); ?></div>
                        </div>

                        <div class="wd-nvr-info-item">
                            <div class="wd-nvr-info-label">System Status</div>
                            <div class="wd-nvr-info-value" style="color: <?php echo e(($nvr['status'] ?? 'alert') === 'alert' ? 'var(--wd-red)' : 'var(--wd-green)'); ?>">
                                <?php echo e(strtoupper($nvr['status'] ?? 'UNKNOWN')); ?>
                    ...
                    <div class="wd-nvr-cameras">
                        <div class="wd-nvr-cam-stat total">
                            ...
                            <div class="wd-nvr-cam-value"><?php echo e($nvr['total_cameras'] ?? 0); ?></div>
                        </div>

                        <div class="wd-nvr-cam-stat online">
                            <div class="wd-nvr-cam-label">Online Cameras</div>
                            <div class="wd-nvr-cam-value"><?php echo e($nvr['online_cameras'] ?? 0); ?></div>
                        </div>

                        <div class="wd-nvr-cam-stat offline">
                            <div class="wd-nvr-cam-label">Offline Cameras</div>
                            <div class="wd-nvr-cam-value"><?php echo e($nvrTotalOffline); ?></div>
                        </div>
                    </div>

                    <!-- Footer -->
                    <div class="wd-nvr-footer">
                        Last synced: <?php echo e(($nvr['last_synced_at'] ?? null) ? \Carbon\Carbon::parse($nvr['last_synced_at'])->format('d M Y, H:i') : 'Never'); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ATS\vss\resources\views\cameras\warehouse_details.blade.php ENDPATH**/ ?>