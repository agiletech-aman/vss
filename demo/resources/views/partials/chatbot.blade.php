{{-- ═══════════════════════════════════════════════════════════════
     FILE: resources/views/partials/chatbot.blade.php
     Include in layout.master just before </body>:
       @include('partials.chatbot')

     UPDATED: v2.0
     - KB: Warehouse count, region stats, alert severity, NVR/device details
     - KB: Total warehouses, active regions, worst/best region queries
     - UI: Refined typography, spacing, micro-animations, pulse indicators
     - UI: Severity badge system, animated KPI rows, smooth transitions
═══════════════════════════════════════════════════════════════ --}}
