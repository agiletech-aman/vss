...
<div style="padding: 0;">
    ...
    <div class="alert-header">
        ...
        <a href="{{ route('dashboard') }}" class="alert-back-btn">
        ...
        <form method="GET" id="filterForm" class="row g-3">
            ...
            <div class="col-md-2">
                ...
                <div class="filter-actions">
                    ...
                    <a href="{{ route('alerts.fire') }}" class="btn-reset"><i class="ri-refresh-line"></i></a>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="table-card">
        <div class="table-card-header">
            ...
            <div style="display:flex;align-items:center;gap:10px;">
                ...
                @endif
                @if($alerts->count() > 0)
                <a href="{{ route('alerts.fire.export') }}?{{ http_build_query(request()->query()) }}"
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if(!empty($row['imagePath']))
                                    ...
                                    <img src="{{ $imageUrl }}" class="preview-img" data-full="{{ $imageUrl }}" loading="lazy" onerror="this.style.display='none'" alt="Fire Alert">
                                @else
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const preselectedLocation = @json(request('location'));
    const preselectedState    = @json(request('state'));
    ...
    if (stateSelect) {
        stateSelect.addEventListener('change', function () {
            ...
            fetch('{{ route("alerts.locations-by-state") }}?state=' + encodeURIComponent(state), { headers: {'X-Requested-With':'XMLHttpRequest','Accept':'application/json'} })
