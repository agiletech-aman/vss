...
<div class="map-card card-loading" data-card="map">
    ...
    <div class="map-hdr">
        ...
        <a href="{{ route('nms.pages.map') }}" class="map-link">Full Map <i class="ri-arrow-right-up-line"></i></a>
    </div>
...
<div class="kpi-row">
    <div class="kpi-card kc-blue card-loading" data-card="frs2" style="animation-delay:.00s;cursor:pointer" onclick="window.location.href='{{ route('frs.logs') }}'">
        <div class="card-loading-overlay"><div class="dots-loader"><div class="dot"></div><div class="dot"></div><div class="dot"></div></div></div>
        <div class="kpi-body">
            <div class="kpi-hdr">
                <div>
            ...
            <div class="kpi-foot"><a href="{{ route('frs.logs') }}" class="kpi-link" style="color:var(--navy)" onclick="event.stopPropagation();">View FRS Logs <i class="ri-arrow-right-line"></i></a></div>
        </div>
    </div>
    <div class="kpi-card kc-red card-loading" data-card="fire" onclick="window.location.href='{{ route('alerts.fire') }}'"" style="animation-delay:.07s">
        <div class="card-loading-overlay"><div class="dots-loader"><div class="dot"></div><div class="dot"></div><div class="dot"></div></div></div>
        <div class="kpi-body">
            <div class="kpi-hdr">
                <div>
            ...
            <div class="kpi-foot"><a href="{{ route('alerts.fire') }}" class="kpi-link" onclick="event.stopPropagation();">View Reports <i class="ri-arrow-right-line"></i></a></div>
        </div>
    </div>
    <div class="kpi-card kc-orange card-loading" data-card="smoke" onclick="window.location.href='{{ route('alerts.smoke') }}'"" style="animation-delay:.14s">
        <div class="card-loading-overlay"><div class="dots-loader"><div class="dot"></div><div class="dot"></div><div class="dot"></div></div></div>
        <div class="kpi-body">
            <div class="kpi-hdr">
                <div>
            ...
            <div class="kpi-foot"><a href="{{ route('alerts.smoke') }}" class="kpi-link" onclick="event.stopPropagation();">View Reports <i class="ri-arrow-right-line"></i></a></div>
        </div>
    </div>
    <div class="kpi-card kc-teal card-loading" data-card="rodent" onclick="window.location.href='{{ route('alerts.rodent') }}'"" style="animation-delay:.21s">
        <div class="card-loading-overlay"><div class="dots-loader"><div class="dot"></div><div class="dot"></div><div class="dot"></div></div></div>
        <div class="kpi-body">
            <div class="kpi-hdr">
                <div>
            ...
            <div class="kpi-foot"><a href="{{ route('alerts.rodent') }}" class="kpi-link" onclick="event.stopPropagation();">View Reports <i class="ri-arrow-right-line"></i></a></div>
        </div>
    </div>
</div>

{{-- BTS TILE + DEVICES TILE --}}
...
{{-- IoT Sensor Alerts commented out
<div class="sec-div"><i class="ri-sensor-line"></i> IoT Sensor Alerts</div>
<div class="iot-row">
    <div class="iot-card ic-co2 card-loading" data-card="co2" style="animation-delay:.36s" onclick="window.location.href='{{ route('alerts.index', ['deviceTypeId' => 30000]) }}'"">
        <div class="card-loading-overlay"><div class="dots-loader"><div class="dot"></div><div class="dot"></div><div class="dot"></div></div></div>
        <div class="iot-banner"></div>
        <div class="iot-inner">
            <div class="iot-hdr"><div class="iot-hdr-l"><div class="iot-ico"><i class="ri-temp-cold-line"></i></div><div><div class="iot-eye">CO₂ Sensor</div><div class="iot-name">Carbon Dioxide Alerts</div></div></div><span class="sens-badge"><i class="ri-base-station-line"></i> <span data-stat="co2SensorTotal">—</span></span></div>
            <div class="sev-grid">
                <a href="{{ route('alerts.index', ['deviceTypeId' => 30000, 'alertType' => 'SEVERE']) }}" class="sev-pill sp-severe" onclick="event.stopPropagation();"><div class="sev-tag">Severe</div><div class="sev-num" data-stat="co2Severe">0</div></a>
                <a href="{{ route('alerts.index', ['deviceTypeId' => 30000, 'alertType' => 'CRITICAL']) }}" class="sev-pill sp-critical" onclick="event.stopPropagation();"><div class="sev-tag">Critical</div><div class="sev-num" data-stat="co2Critical">0</div></a>
            </div>
            <div class="iot-foot"><a href="{{ route('alerts.index', ['deviceTypeId' => 30000]) }}" class="iot-lnk" onclick="event.stopPropagation();">View All CO₂ Reports <i class="ri-arrow-right-line"></i></a></div>
        </div>
    </div>
    <div class="iot-card ic-ph3 card-loading" data-card="ph3" style="animation-delay:.42s" onclick="window.location.href='{{ route('alerts.index', ['deviceTypeId' => 30001]) }}'"">
        <div class="card-loading-overlay"><div class="dots-loader"><div class="dot"></div><div class="dot"></div><div class="dot"></div></div></div>
        <div class="iot-banner"></div>
        <div class="iot-inner">
            <div class="iot-hdr"><div class="iot-hdr-l"><div class="iot-ico"><i class="ri-flask-line"></i></div><div><div class="iot-eye">PH₃ Sensor</div><div class="iot-name">Phosphine Alerts</div></div></div><span class="sens-badge"><i class="ri-base-station-line"></i> <span data-stat="ph3SensorTotal">—</span></span></div>
            <div class="sev-grid">
                <a href="{{ route('alerts.index', ['deviceTypeId' => 30001, 'alertType' => 'SEVERE']) }}" class="sev-pill sp-severe" onclick="event.stopPropagation();"><div class="sev-tag">Severe</div><div class="sev-num" data-stat="ph3Severe">0</div></a>
                <a href="{{ route('alerts.index', ['deviceTypeId' => 30001, 'alertType' => 'CRITICAL']) }}" class="sev-pill sp-critical" onclick="event.stopPropagation();"><div class="sev-tag">Critical</div><div class="sev-num" data-stat="ph3Critical">0</div></a>
            </div>
            <div class="iot-foot"><a href="{{ route('alerts.index', ['deviceTypeId' => 30001]) }}" class="iot-lnk" onclick="event.stopPropagation();">View All PH₃ Reports <i class="ri-arrow-right-line"></i></a></div>
        </div>
    </div>
    <div class="iot-card ic-frs card-loading" data-card="frs" style="animation-delay:.48s" onclick="window.location.href='{{ route('frs.logs') }}'"">
        <div class="card-loading-overlay"><div class="dots-loader"><div class="dot"></div><div class="dot"></div><div class="dot"></div></div></div>
        <div class="iot-banner"></div>
        <div class="iot-inner">
            <div class="iot-hdr"><div class="iot-hdr-l"><div class="iot-ico"><i class="ri-shield-user-line"></i></div><div><div class="iot-eye">FRS System</div><div class="iot-name">Unknown Identities</div></div></div><span class="sens-badge"><i class="ri-camera-lens-line"></i> <span data-stat="frsCameraTotal">—</span> Cams</span></div>
            <div class="sev-grid"><div class="sev-pill sp-frs"><div class="sev-tag">Unidentified Faces Detected</div><div class="sev-num" data-stat="frsUnknown">0</div></div></div>
            <div class="iot-foot"><a href="{{ route('frs.logs') }}" class="iot-lnk" onclick="event.stopPropagation();">View FRS Logs <i class="ri-arrow-right-line"></i></a></div>
        </div>
    </div>
</div>
    ...
    <div class="gas-inner">
        ...
        <div id="gLocationView" style="display:none;">
            ...
            <div class="gas-loc-wrap">
                <table class="gas-tbl">
                    <thead><tr><th>Location</th><th>IoT Devices</th><th>Online</th><th>Normal</th><th>Severe</th><th>Critical</th></tr></thead>
...
async function renderNmsStrip() {
    ...
    try {
        ...
        fetch('{{ config("external-apis.nms_cam_base", "https://new.cwcnewcctv.in") }}/api/v1/cameras/by-warehouse')
...
async function renderNmsStripDirect() {
    ...
    try {
        const [regR, whR, statsR, gasR] = await Promise.all([
            ...
            fetch('{{ config("external-apis.co2_summary") }}').then(r=>r.ok?r.json():null).catch(()=>null).then(r => { if(!r){ console.warn('[Gas] co2_summary config empty/failed, trying direct'); return fetch('https://co2ph3master.ajeevi.in/api/summary').then(x=>x.ok?x.json():null).catch(()=>null); } return r; }),
        ]);
    ...
    sackWhChart = new Chart(ctx, {
        ...
        options:{
            ...
            onClick:(e,els)=>{
                ...
                if (w.warehouse_id) {
                    window.location.href = '{{ route("sack.count") }}?region_id='+encodeURIComponent(w.region_id||'')+'&warehouse_id='+encodeURIComponent(w.warehouse_id)+'&warehouse_name='+encodeURIComponent(w.warehouse_name||'')+'&region_name='+encodeURIComponent(w.region_name||'');
                }
            },
            plugins:{
                legend:{display:true,position:'top',align:'end',labels:{font:{family:'DM Sans',size:11,weight:'600'},boxWidth:10,boxHeight:10,borderRadius:3,useBorderRadius:true,padding:14}},
...
(function(){
    ...
    var GAS_API='{{ config("external-apis.co2_summary") }}';
    ...
    function gBuildLocRows(){var isCO2=gGas==='co2',lw=gData.locationWise||{};gAllRows=[];Object.entries(lw).forEach(function(entry){var key=entry[0],loc=entry[1];gAllRows.push({name:loc.locationName||key,state:loc.state||'—',iot:loc.totalIotDevices||0,online:isCO2?(loc.onlineCO2||0):(loc.onlinePH3||0),offline:(loc.totalIotDevices||0)-(isCO2?(loc.onlineCO2||0):(loc.onlinePH3||0)),normal:isCO2?(loc.normalCO2||0):(loc.normalPH3||0),severe:isCO2?(loc.severeCO2||0):(loc.severePH3||0),critical:isCO2?(loc.criticalCO2||0):(loc.criticalPH3||0)});});gAllRows.sort(function(a,b){return(b.critical-a.critical)||(b.severe-a.severe);});window.__gasAllRows=gAllRows;var cnt=document.getElementById('gLocCount');if(cnt)cnt.textContent=gAllRows.length+' locations';gRenderRows(gAllRows);}
...
const _KPI_META = {
    regions:    { eye:'',   title:'Region',       icon:'ri-map-pin-2-line',    banner:'#1e3a5f,#1e40af' },
...
<td style="padding:8px 12px;border-bottom:1px solid #f0f4f8;font-size:11px;color:#475569;font-family:'IBM Plex Mono',monospace">${w.epc_status_changed_at?fmtDt(w.epc_status_changed_at):'—'}</td>
    ...
    if (key==='co2'||key==='ph3') {
        ...
        else { fetch('{{ config("external-apis.co2_summary") }}').then(r=>r.ok?r.json():null).catch(()=>null).then(renderSensorLocs); }
        modal.style.display='flex'; document.body.style.overflow='hidden'; return;
    }
...
async function openConfiguredWh() {
    ...
    try {
        ...
        const mkRow = (w, statusColor, statusLabel) => `<tr onclick="window.location.href='/nms/warehouses/${w.warehouse_id}';closeKpiModal()"
            onmouseover="this.style.background='#f0f6ff'" onmouseout="this.style.background=''"
            style="cursor:pointer;transition:background .12s">
            <td style="padding:8px 12px;border-bottom:1px solid #f0f4f8">
                <div style="font-weight:700;display:flex;align-items:center;gap:3px">${w.warehouse_name}<i class="ri-arrow-right-s-line" style="font-size:12px;color:#3b82f6"></i></div>
        ...
        const secHdr = (label, color, count) =>
            `<tr><td colspan="5" style="padding:8px 12px;background:#f8fafc;font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:${color};border-bottom:1.5px solid #e2e8f0">
                <i class="ri-circle-fill" style="font-size:7px"></i> ${label} (${count})
            </td></tr>`;
        ...
        listEl.innerHTML = `<div style="max-height:400px;overflow-y:auto">
            <table style="width:100%;border-collapse:collapse;font-size:12px">
                ...
                <tbody>
                    ${activeOn.length  ? secHdr('Online',  '#059669', activeOn.length)  + activeOn.map(w=>mkRow(w)).join('')  : ''}
                    ${activeOff.length ? secHdr('Offline', '#dc2626', activeOff.length) + activeOff.map(w=>mkRow(w)).join('') : ''}
                    ${!activeOn.length && !activeOff.length ? '<tr><td colspan="5" style="padding:20px;text-align:center;color:#94a3b8">No active warehouses</td></tr>' : ''}
                </tbody>
            </table>
        </div>`;
    } catch(e) {
